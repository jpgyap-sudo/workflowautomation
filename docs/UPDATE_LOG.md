...
| 2026-05-27 01:03 | Roo (Code) | Fix: add delivery date to Telegram notification for delivery_scheduled stage updates — both persistent reminder and Stage Update message now show the scheduled delivery date | 🔴 Active |
