...
| 2026-05-28 00:44 | Roo (Code) | Feat: AI chatbox draggable — ChatFloatingIcon now supports mouse/touch drag via the header. Uses CSS transform translate() for smooth repositioning. | 🔴 Active |
